      ...
      <form role="form" id="joinForm" method="post" action="/member/join">
        <div class="box-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-8">
              <input type="email" class="form-control" name="member_email" id="member_email" placeholder="이메일 입력">
            </div>
            <div class="col-2">
          ...
          <div class="form-group row">
            ...
            <div class="col-8">
              <input type="text" class="form-control" name="member_zipcode" id="sample2_postcode" placeholder="우편번호 입력">
            </div>
            <div class="col-2">
          ...
          <div class="form-group row">
            ...
            <div class="col-10">
              <input type="text" class="form-control" name="member_addr" id="sample2_address" placeholder="주소입력">
            </div>
          </div>
          <div class="form-group row">
