    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-10">
            <input type="email" class="form-control" name="member_email" id="member_email" value="${memberVO.member_email }">
          </div>
        </div>
        <div class="form-group row">
          <label for="sample2_postcode" class="col-2">우편번호</label>
          <div class="col-8">
            <input type="text" class="form-control" name="member_zipcode" id="sample2_postcode" value="${memberVO.member_zipcode }" placeholder="우편번호 입력">
          </div>
          <div class="col-2">
        ...
        <div class="form-group row">
          ...
          <div class="col-10">
            <input type="text" class="form-control" name="member_addr" id="sample2_address" value="${memberVO.member_addr }" placeholder="주소입력">
          </div>
        </div>
        <div class="form-group row">
          <label for="sample2_detailAddress" class="col-2">상세주소</label>
          <div class="col-10">
            <input type="text" class="form-control" name="member_deaddr" id="sample2_detailAddress" value="${memberVO.member_deaddr }" placeholder="상세주소">
        ...
        <div class="form-group row">
          ...
          <div class="col-10">
            <input type="text" class="form-control" name="member_phone" id="member_phone" value="${memberVO.member_phone }" placeholder="전화번호">
          </div>
        </div>      
      </div>
