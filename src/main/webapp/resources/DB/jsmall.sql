...
INSERT INTO PAYMENT (
    PAY_CODE, ODR_CODE, MEMBER_ID, PAY_METHOD, PAY_DATE, PAY_TOT_PRICE,
    PAY_MEMO, PAY_NOBANK_PRICE, PAY_NOBANK_USER, PAY_NOBANK, PAY_BANK_ACCOUNT 
) VALUES (
    SEQ_PAYMENT_CODE.NEXTVAL,3,'user01','무통장입금',sysdate,1550000,'',
    1550000, '손흥민','국민은행', '456-456-4567')
