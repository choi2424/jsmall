...
import com.jsmall.kakaopay.ApproveResponse;
...
public class KakaoPayServiceImpl {
	...
	*/
	...
	private HttpHeaders getHeaderInfo() {
		...
		headers.set("Authorization","KakaoAK 628cb82fc1f3f7e34a5aa42bd37eae55");
	...
	*/
	...
	public ReadyResponse payReady(Long odr_code, String itemName,int quantity, String member_id , int totalAmount) {
		
		MultiValueMap<String, String> parameters = new LinkedMultiValueMap<String, String>();
		
		parameters.add("cid", "TC0ONETIME"); // 가맹점 코드, 10자
		parameters.add("partner_order_id", ""+ odr_code); // 가맹점 주문번호, 최대 100자
		parameters.add("partner_user_id", member_id); // 가맹점 회원 id, 최대 100자
	...
	*/
	...
	public ApproveResponse payApprove(Long oder_code,String tid,String pgToken,String member_id) {
		...
		parameters.add("partner_user_id", member_id); // 가맹점 회원 id, 결제 준비 API 요청과 일치해야 함
